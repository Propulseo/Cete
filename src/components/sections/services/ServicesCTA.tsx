      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#EC8D19]/30 bg-[#EC8D19]/10 px-4 py-2 mb-8">
            ...
            <span className="text-sm font-medium text-[#EC8D19]">Passez à l&apos;action</span>
          </div>

          <h2 className="font-display text-4xl md:text-5xl lg:text-6xl text-white tracking-wide mb-6">
            PRÊT À{" "}
            <span className="text-[#EC8D19]">PROGRESSER</span>
            {" "}VERS LE AAA ?
          </h2>

          <p className="text-lg md:text-xl text-white/70 mb-10 max-w-2xl mx-auto">
            Demandez votre évaluation initiale. Nous construirons ensemble
            le programme d&apos;accompagnement adapté à votre notation.
          </p>
