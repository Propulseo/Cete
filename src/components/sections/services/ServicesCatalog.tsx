    ...
    <section className="py-32 bg-[#F4F9FD] relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-12 gap-6">
          <Link href="/contact" className="block md:col-span-7 group">
          ...
          <div className="md:col-span-5 flex flex-col gap-4 lg:gap-6">
            {conseilServices.slice(1).map((service) => (
              <Link
                key={service.id}
                href="/contact"
                className="block group relative bg-white rounded-3xl p-5 lg:p-8 hover:shadow-2xl transition-all duration-500 cursor-pointer border-2 border-transparent hover:border-[#E8630A]"
              >
                <div className="flex items-start gap-3 lg:gap-6">
                  <div className="w-12 h-12 lg:w-16 lg:h-16 rounded-2xl bg-[#4DA6D9] flex items-center justify-center text-white flex-shrink-0 group-hover:scale-110 transition-transform duration-500">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="hidden lg:flex items-center gap-4 mt-4 text-sm text-[#8AA5BE]">
